...
data Gene = Place Int Int | NOP | Up Int | Down Int | Left Int | Right Int | Neg Int | GetNearestSpider Int | GetNearestPlant Int | GetMag Int Int | IfLt Int Int | EndIf | IfGt Int Int | GetX Int Int | GetY Int Int | Reproduce Int deriving(Show, Eq, Ord, Generic, NFData)
